...
const Dust = () => {
  ...
  return (
    <Box m="1.5rem 2.5rem">
      <FlexBetween>
        <Header title="DUST DENSITY" subtitle="Real-time dust density analytics and trends" />
        <Box>
          <Button
            sx={{
      ...
      >
        ...
        />
        <StatBox
          title="Highest Dust Density Today"  
          value="15 mg/m³"
          increase="+2%"
          description="Since last month"
          icon={
        ...
        />
<StatBox
          title="Lowest Dust Density Today"
          value="5 mg/m³"
          increase="+1%"
          description="Since last month"
          icon={
